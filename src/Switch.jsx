...
const Switch = ({toggle , color}) => {
  return (
    <StyledWrapper>
      <label className="theme-switch">
        <input type="checkbox" className="theme-switch__checkbox" style={{backgroundColor: color ? "black":"white", color : color? "white":"black"}} onClick={toggle} />
